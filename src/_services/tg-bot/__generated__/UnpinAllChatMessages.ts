...
import {
  UnpinAllChatMessagesCreateData,
  UnpinAllChatMessagesCreateError,
  UnpinAllChatMessagesCreatePayload,
} from "./data-contracts";
import { ContentType, HttpClient, RequestParams } from "./http-client";

export class UnpinAllChatMessages<SecurityDataType = unknown> {
   ...
   *
   * @name UnpinAllChatMessagesCreate
   * @request POST:/unpinAllChatMessages
   */
  unpinAllChatMessagesCreate = (
    data: UnpinAllChatMessagesCreatePayload,
